...
exports.createCategory = async (req, res, newCategoryId) => {
  try {
    console.log("CONTROLLER - Creating category with data:", {
      name: req.body.name,
    ...
    console.log("CONTROLLER - Category created successfully:", savedCategory);
    res.status(201).json(ApiResponse(savedCategory, "Category created successfully", true, 201));
  } catch (err) {
    console.error("CONTROLLER - Create category error:", err);
